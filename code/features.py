...
def calculate_feature_for_all_audio_files():
    ...
    dataset_dir = 'D:\\project_wildlife_sound_30_sec\\feature_extraction\\files\\'
    workspace = 'D:\\project_wildlife_sound_30_sec\\feature_extraction\\files\\'
...
if __name__ == '__main__':
    ...
    mode = 'calculate_feature_for_all_audio_files'
    # mode = 'calculate_scalar'
    
    if mode == 'calculate_feature_for_all_audio_files':
